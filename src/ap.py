...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="rf", help=f"Name of model. Available str: {MODEL_MAP}")
    parser.add_argument("--model_ckpt", type=str, default="./model/ckpt/rf_final.pkl")
